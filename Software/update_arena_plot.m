...
if handles.video.FrameRate*(str2double(handles.first_time_edit.String))>handles.data.i_start
    i_first=floor(handles.video.FrameRate*(str2double(handles.first_time_edit.String)));
else
    i_first=handles.data.i_start;
end

if handles.video.FrameRate*(str2double(handles.last_time_edit.String))<handles.data.i_end
    i_last=floor(handles.video.FrameRate*(str2double(handles.last_time_edit.String)));
else
...
if H==1
    plot(Head(1,i_first:i_last),Head(2,i_first:i_last),'r');
    hold on
...
if C==1
    plot(Centroid(1,i_first:i_last),Centroid(2,i_first:i_last),'k');
    hold on
...
if T==1
    plot(Tail(1,i_first:i_last),Tail(2,i_first:i_last),'b');
    hold on
